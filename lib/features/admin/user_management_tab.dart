...
final allUsersProvider = FutureProvider<List<Map<String, dynamic>>>((ref) async {
  final response = await SupabaseService.client
      .from('profiles')
      .select('id, full_name, role, phone, address, gender, dob, created_at')
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                child: Text(
                                  'Akun admin baru akan langsung aktif dengan role Admin.',
                                  style: GoogleFonts.poppins(
                          ...
                          child: ElevatedButton.icon(
                            ...
                            onPressed: isLoading
                                ...
                                : () async {
                                    ...
                                    if (!email.contains('@')) {
                                      setDialogState(() => errorMsg = 'Format email tidak valid.');
                                      return;
                                    }
                                    if (pass.length < 6) {
                                    ...
                                    if (pass != confirm) {
                                      setDialogState(() => errorMsg = 'Password dan konfirmasi tidak cocok.');
                                      return;
                                    }
                            ...
                            label: Text(
                              isLoading ? 'Membuat Akun...' : 'Buat Admin',
                              style: GoogleFonts.poppins(
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('✅ Admin "$name" berhasil dibuat!'),
                        ...
                        child: RefreshIndicator(
                          ...
                          child: ListView.separated(
                            padding: const EdgeInsets.only(
                                top: 8, bottom: 88), // beri ruang di bawah FAB
